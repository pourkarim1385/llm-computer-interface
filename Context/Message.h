...
namespace agent::chat {
    ...
    public:
        ...
        [[nodiscard]] const std::string& getRawResult() const noexcept { return m_llmRawResult; }
        [[nodiscard]] const std::string& getResult() const noexcept { return m_llmResult; }
